...
public class FourSquareProfile implements Serializable {
	 ...
	 */
	public FourSquareProfile(String id, String firstName, String lastName,
	...
	public String toString() {
		return "FourSquareController [id=" + getId() + ", firstName="
